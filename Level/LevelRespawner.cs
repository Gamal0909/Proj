...
{
    [AddComponentMenu("Series/Platformer/Level/Level Respawner")]
    public class LevelRespawner : Singleton<LevelRespawner>
    {
        ...
        {
            health = m_level.player.GetComponent<Health>();
            power = m_level.player.GetComponent<Power>();
            stamina = m_level.player.GetComponent<Stamina>();
