...
{
	[CreateAssetMenu(fileName = "NewPlayerStats", menuName = "Series/Platformer/Player/New Player Stats")]
	public class PlayerStats : EntityStats<PlayerStats>
	{
		...
		[Header("Draw Sword Stats")]
		public bool canDrawSword = true;
		public float drawBackSwordDuration = 0.5f;
