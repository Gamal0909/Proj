...
{
	[AddComponentMenu("Series/Platformer/Player/Player Input Manager")]
	public class PlayerInputManager : MonoBehaviour
	{
		...
		protected InputAction m_drawSword;
		protected InputAction m_UndrawSword;
		protected InputAction m_attack;
		protected InputAction m_light;
		...
		protected virtual void CacheActions()
		{
			...
			m_drawSword = actions["Draw"];
			m_attack = actions["Attack"];
			m_UndrawSword = actions["UnDraw"];
			m_light = actions["Light"];


        }
		// Add this new method after GetMovementDirection()
		public virtual Vector2 GetMovement()
		{
			// Read raw input value directly from the movement action
			return m_movement.ReadValue<Vector2>();
		}
		...
		public virtual bool GetDrawSword() => m_drawSword.WasPressedThisFrame();
		public virtual bool GetUndrawSword() => m_UndrawSword.WasPressedThisFrame();
		public virtual bool GetAttack() => m_attack.WasPressedThisFrame();
		public virtual bool GetLight() => m_light.IsPressed();
