...
namespace Series.Core
{
	...
	public class PlayerAnimator : MonoBehaviour
	{
		...
		public string drawSwordTriggerName = "DrawSword";
        public string comboCountTriggerName = "ComboCount";
		...
		protected int m_drawSwordTriggerHash;
		protected int m_onStateChangedHash;
        protected int m_comboCountHash;
		...
		{
			m_player.states.events.onChange.AddListener(() => animator.SetTrigger(onStateChangedName));
		}
		...
		protected virtual void InitializeParametersHash()
		{
			...
			m_drawSwordTriggerHash = Animator.StringToHash(drawSwordTriggerName);
			m_comboCountHash = Animator.StringToHash(comboCountTriggerName);
		...
		{
            animator.SetTrigger(drawSwordTriggerName);
        }
        public void SetComboCount(int count)
        {
            animator.SetInteger(comboCountTriggerName, count);
        }
